...
/** CUP v0.10k TUM Edition 20050516 generated parser.
  * @version Thu Sep 23 09:33:20 CEST 2021
  */
public class parser extends java_cup.runtime.lr_parser {
  ...
  protected static final short[][] _action_table = 
    unpackFromStrings(new String[] {
    "\000\007\000\006\002\uffff\004\004\001\002\000\006\002" +
    "\ufffc\004\ufffe\001\002\000\004\002\007\001\002\000\004" +
    "\002\001\001\002\000\004\002\000\001\002\000\004\004" +
  ...
  protected static final short[][] _reduce_table = 
    unpackFromStrings(new String[] {
    "\000\007\000\006\003\004\004\005\001\001\000\004\005" +
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$parser$act_num)
		...
		String n = (String)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-0)).value;
		  nb++; System.out.println(" BINAIRE : "+n); 
                            if(maxBinaire < n.length()) {
                                    maxBinaire = n.length();
                                }
                        
              CUP$parser$result = new java_cup.runtime.Symbol(2/*list_binaire*/, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-0)).left, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-0)).right, RESULT);
            }
          return CUP$parser$result;

          /*. . . . . . . . . . . . . . . . . . . .*/
          case 4: // list_binaire ::= BINAIRE NT$0 list_binaire 
            {
              Object RESULT = null;
		...
		String n = (String)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
              ...
              CUP$parser$result = new java_cup.runtime.Symbol(2/*list_binaire*/, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)).left, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-0)).right, RESULT);
            }
          return CUP$parser$result;
